...
And I verify the value "NZ" as "Country"
...
And I check "Subcategories" as "Abseiling"
...
And I check "Sub-Recipients" as "Husband"
And I check "Sub-Recipients" as "Baby Girl"
