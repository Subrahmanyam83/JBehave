...
import com.unitedinternet.portal.selenium.utils.logging.LoggingBean;
...
public class LoggingCommandProcessor implements CommandProcessor {
    ...
    static public BufferedWriter loggingWriter;
    /**
     * Constructor.
     *
     ...
     */
    public LoggingCommandProcessor(CommandProcessor commandProcessor) {
