...
Scenario: Edit credit expiry date in AlfRED and Test in AlfRED view page/Edit page
Given that I logged into alfred site and search Simon Fuller
When I click "Edit" link
Then I wait for "10" seconds
Then I click Edit Credit
And I add "4010" as Edit Credit
And I add "24/12/2012" as Expiry Date Edit
