...
And I select "Caving" as Secondary Subcategories under Primary and Secondary Subcategories
And I click "SAVE THESE MAPPINGS" button
And I see Selected mappings added!
And I wait for "10" seconds

And I select "80th Birthday" under Sub Occassions
And I select "10th Birthday" under Sub Occassions
And I see Selected mappings added!
And I wait for "10" seconds

And I select "Baby Girl" under Sub Recipients
And I select "Girlfriend" under Sub Recipients
And I see Selected mappings added!
And I wait for "10" seconds
...
And I enter the Primary category as "Skating"
And I enter the Category as "Men's Gift Boxes"
And I enter the Category as "Couples Gift Boxes"
And I enter the Occassion as "New Baby"
And I enter the Occassion as "Romantic"	
And I enter the recipient as "Boyfriend"
And I enter the recipient as "Wife"
...
And I check "Sub-Recipient" as "Wife"
